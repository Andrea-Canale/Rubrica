...
namespace Rubrica.Griglia
{
    public class Griglia
    {
        public void CreateGrid(DataGridView dg)
        {
            ...
            dg.Invoke(new Action(() => dg.ColumnCount = 4 ));
            dg.Invoke(new Action(() => dg.Columns[0].Name = "ID"));
            dg.Invoke(new Action(() => dg.Columns[1].Name = "Nome"));
            dg.Invoke(new Action(() => dg.Columns[2].Name = "Cognome"));
            dg.Invoke(new Action(() => dg.Columns[3].Name = "Numero"))
